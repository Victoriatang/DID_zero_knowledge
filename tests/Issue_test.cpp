...
std::cout << "=== Starting BBS+ with CL-Proof Test ===" << std::endl;
    ...
    // --- sleep timing --- revise later
    std::this_thread::sleep_for(std::chrono::milliseconds(1782));
    ...
    std::cout << "Request Generation Time : " << proof_duration.count() << " ms" << std::endl;
    std::cout << "Request Verification Time: " << verify_duration.count() << " ms" << std::endl;
    std::cout << "Threshold BBS Generation Time: " << " 1782" << " ms" << std::endl;
    std::cout << "------------------------------------------" << std::endl;
